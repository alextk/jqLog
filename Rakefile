...
project = JsProjectBuilder.new(
  ...
  :js_files => %w{base.js level.js layouter.js logger.js loggers-manager.js array-console.js browser-console.js console-appender.js ajax-appender.js jqlog.js}
)
